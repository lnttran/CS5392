...
CREATE TABLE IF NOT EXISTS signatures (
    ...
    signature_template_id INT NOT NULL,
...
CREATE TABLE IF NOT EXISTS attachments (
    ...
    formid VARCHAR NOT NULL,
    attachment_template_id INT NOT NULL,
...
ADD FOREIGN KEY (formid) REFERENCES forms (formid),
    ADD FOREIGN KEY (attachment_template_id) REFERENCES attachment_templates (attachment_template_id);
ALTER TABLE attachment_templates
ADD FOREIGN KEY (formtypeid) REFERENCES form_templates (formtypeid);
INSERT INTO user_titles (title)
VALUES ('Admin');
INSERT INTO users (
        username,
        title_id,
...
VALUES (
        'admin',
        '$2a$10$S3A0h7R4zAKr/699hDAc7OeeLk6LcF6L02HyihUs9g1.DrY3iSJUW',
        TRUE
    );